...
- input_structure: contains the template structure used for the simulations
- scripts:     contains the scripts necessary to perform the analyses as reported in the main text.
- trajectories: contains the trajectories of the two water molecules when deleted, along with a visualisation help(in the form a .vmd script)
